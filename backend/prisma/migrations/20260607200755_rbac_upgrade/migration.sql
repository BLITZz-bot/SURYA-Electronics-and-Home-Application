-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('PRIMARY_ADMIN', 'SECONDARY_ADMIN', 'ADMIN', 'CUSTOMER');
...
CREATE TABLE "StoreSettings" (
    ...
    "storeName" TEXT NOT NULL DEFAULT 'SURYA Electronics',
...
-- AddForeignKey
ALTER TABLE "RoleLog" ADD CONSTRAINT "RoleLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoleLog" ADD CONSTRAINT "RoleLog_changedBy_fkey" FOREIGN KEY ("changedBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
